...
func TestReElection2A(t *testing.T) {
	...
	DPrintf("")
	DPrintf("------------------------------------- node=%v disconnects, a new one should be elected.", leader1)
	DPrintf("")
	...
	DPrintf("")
	DPrintf("------------------------------------- node=%v rejoins", leader1)
	DPrintf("")
	cfg.connect(leader1)
	...
	// be elected.
	DPrintf("")
	DPrintf("------------------------------------- [node=%v node=%v] downs, no leader should be elected", leader2, (leader2 + 1) % servers)
	DPrintf("")
	...
	DPrintf("")
	DPrintf("------------------------------------- first node=%v arises", (leader2 + 1) % servers)
	DPrintf("")
	cfg.connect((leader2 + 1) % servers)
	DPrintf("------------------------------------- first node=%v arises      checke leader ------", (leader2 + 1) % servers)
	cfg.checkOneLeader()

	// re-join of last node shouldn't prevent leader from existing.
	DPrintf("")
	DPrintf("------------------------------------- second node=%v arises", leader2)
	DPrintf("")
	cfg.connect(leader2)
	cfg.checkOneLeader()
